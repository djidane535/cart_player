...
from cart_player.backend.api.events import CartSaveBackupEvent
from cart_player.core import Broker, Handler
from cart_player.frontend.domain.commands import EndProgressBarCommand


class CartSaveBackupEventHandler(Handler):
    """Handle event 'CartSaveBackupEvent'."""
    ...
    def message_type(self) -> Type:
        return CartSaveBackupEvent

    def _handle(self, evt: CartSaveBackupEvent):
        if evt.success:
